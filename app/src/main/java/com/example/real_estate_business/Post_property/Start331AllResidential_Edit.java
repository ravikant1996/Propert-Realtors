...
import com.example.real_estate_business.model.AdditioanlDetailsModel;
...
public class Start331AllResidential_Edit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        storageReference = FirebaseStorage.getInstance().getReference().child("PropertyImages/" + propertyId);
