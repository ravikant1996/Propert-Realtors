...
public class AdditioanlDetailsModel {
    String id, refId, facing, society, location, flooring, overLooking,
            landmark, water,
    ...
    openParking, closeParking, suitableFor, construction;

    public AdditioanlDetailsModel() {
    }
    public AdditioanlDetailsModel(String id, String refId, String facing, String society, String location, String flooring, String overLooking, String landmark,
                                  String water, String coverdArea, String pricePSS, String carparking, String electricityAvailability, String gym, String clubHouse,
                                  String park, String parking, String lift, String powerBackup, String gasPipeline, String swimPool,
                                  String covered_areaParameter, String openParking, String closeParking, String suitableFor, String construction) {
        this.id = id;
        this.refId = refId;
        this.facing = facing;
        ...
        this.closeParking = closeParking;
    ...
    public String getCloseParking() {
        return closeParking;
    }

    public void setCloseParking(String closeParking) {
        this.closeParking = closeParking;
    }
