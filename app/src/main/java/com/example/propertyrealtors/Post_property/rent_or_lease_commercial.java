...
public class rent_or_lease_commercial extends Fragment {
    ...
    DetailsAdapterCommRorL dataAdapter;
    LinearLayoutManager HorizontalLayout;
    String UID;

    public rent_or_lease_commercial() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_rent_or_lease_commercial, container, false);
        ...
        try {
            ...
            query.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    dataAdapter = new DetailsAdapterCommRorL(getActivity(), propertyModelArrayList);
