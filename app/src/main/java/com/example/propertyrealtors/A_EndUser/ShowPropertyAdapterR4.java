...
//        inflater = LayoutInflater.from(context);
    ...
    @NonNull
    @Override
    public ShowPropertyAdapterR4.ShowPropertyAdapterViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(context).inflate(R.layout.layout_show_property, parent,false);
        ShowPropertyAdapterR4.ShowPropertyAdapterViewHolder viewHolder = new ShowPropertyAdapterR4.ShowPropertyAdapterViewHolder(view);
        return viewHolder;
    }
