...
public class ShowPropertyAdapterR3 extends RecyclerView.Adapter<ShowPropertyAdapterR3.ShowPropertyAdapterViewHolder> {
    Context context;
    ArrayList<PropertyModel> arrayList= new ArrayList<>();
    ArrayList<Image> imageArrayList =new ArrayList<>();
    LayoutInflater inflater;

    public ShowPropertyAdapterR3(Context context, ArrayList<PropertyModel> propertyModelArrayList, ArrayList<Image> images) {
...
//        inflater = LayoutInflater.from(context);
    ...
    @NonNull
    @Override
    public ShowPropertyAdapterR3.ShowPropertyAdapterViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(context).inflate(R.layout.layout_show_property, parent,false);
        ShowPropertyAdapterR3.ShowPropertyAdapterViewHolder viewHolder = new ShowPropertyAdapterR3.ShowPropertyAdapterViewHolder(view);
        return viewHolder;
    }
