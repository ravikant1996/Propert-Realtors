...
public class ShowPropertyAdapterR2 extends RecyclerView.Adapter<ShowPropertyAdapterR2.ShowPropertyAdapterViewHolder> {
    Context context;
    ArrayList<PropertyModel> arrayList= new ArrayList<>();
    ArrayList<Image> imageArrayList =new ArrayList<>();
    LayoutInflater inflater;

    public ShowPropertyAdapterR2(Context context, ArrayList<PropertyModel> propertyModelArrayList, ArrayList<Image> images) {
...
//        inflater = LayoutInflater.from(context);
    ...
    @NonNull
    @Override
    public ShowPropertyAdapterR2.ShowPropertyAdapterViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(context).inflate(R.layout.layout_show_property, parent,false);
        ShowPropertyAdapterR2.ShowPropertyAdapterViewHolder viewHolder = new ShowPropertyAdapterR2.ShowPropertyAdapterViewHolder(view);
        return viewHolder;
    }
