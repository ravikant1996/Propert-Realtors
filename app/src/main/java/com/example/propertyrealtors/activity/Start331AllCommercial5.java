...
public class Start331AllCommercial5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_start331_all_commercial5);
    ...
    public void back(View view) {
        startActivity(new Intent(Start331AllCommercial5.this, Start331All.class));
        finish();
    }
    ...
    public void validate(){
        ...
        if (TextUtils.isEmpty(construction_done)) {
            ...
            Toast.makeText(Start331AllCommercial5.this, "Select Boundary wall option", Toast.LENGTH_SHORT).show();
            return;

        }else if(TextUtils.isEmpty(plotArea)){
            Toast.makeText(Start331AllCommercial5.this, "Please Enter Area", Toast.LENGTH_SHORT).show();
            return;
        }
       /* else if(TextUtils.isEmpty(plot_length)){
            Toast.makeText(Start331AllCommercial5.this, "Please Enter length", Toast.LENGTH_SHORT).show();
            return;
        }else if(TextUtils.isEmpty(plot_bredth)){
            Toast.makeText(Start331AllCommercial5.this, "Please Enter breadth", Toast.LENGTH_SHORT).show();
            return;
            ...
            if(propertyFor.equals("SELL")) {
                intent = new Intent(Start331AllCommercial5.this, Start331AllResidentialPrice.class);
                intent.putExtras(bundle);
                startActivity(intent);
            }else if(propertyFor.equals("RENT or LEASE")){
                intent = new Intent(Start331AllCommercial5.this, Start332AllResidentialPrice.class);
                intent.putExtras(bundle);
                startActivity(intent);
            }
        }
