...
public class Start23_1_2_3_all extends AppCompatActivity {
    View includedLayout;
    ...
    String minRupeeString, maxRupeeString, flat, office, house;
    String PAGE_LOAD;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_start23_1_2_3_all);
    ...
    public void back(View view) {
        if(PAGE_LOAD.equals("131")) {
            startActivity(new Intent(Start23_1_2_3_all.this, Start131.class));
        }else if(PAGE_LOAD.equals("132")) {
            startActivity(new Intent(Start23_1_2_3_all.this, Start132.class));
        }else if(PAGE_LOAD.equals("133")) {
            startActivity(new Intent(Start23_1_2_3_all.this, Start133.class));
        }
    }

    public void next(View view) {
        Intent intent = new Intent(Start23_1_2_3_all.this, Search_Property.class);
    ...
    public void btnFlat(View view) {
        ...
        if (textView.isSelected()) {
            ...
            areaParameterSpinner.setVisibility(View.GONE);
