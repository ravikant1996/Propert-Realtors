...
import com.example.propertyrealtors.City_Adapter.PlaceAutoSuggestAdapter;
...
public class Start131 extends AppCompatActivity {
    ...
    TextView cityCollect, localityCollect;
    String PURPOSE;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cityCollect = findViewById(R.id.cityCollect);
        localityCollect = findViewById(R.id.localityCollect);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                cityCollect.setVisibility(View.VISIBLE);
                cityCollect.setText(selectedCity);
        ...
        listView2.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                localityCollect.setVisibility(View.VISIBLE);
                localityCollect.setText(selectedCity);
            }
        });
    }
    ...
    public void back(View view) {
        startActivity(new Intent(Start131.this, Start13.class));
        finish();
    }
    ...
    public void next(View view) {
        if(header.getText().toString().length()==0){
            ...
            Toast.makeText(Start131.this, "Please Select City", Toast.LENGTH_SHORT).show();
        }else {
            Toast.makeText(Start131.this, "\n Class: \t " + selectedCity +
            ...
            if(PURPOSE.equals("BUY_A_PROPERTY")) {
                ...
                Intent intent = new Intent(Start131.this, Start23_1_2_3_all.class);
                intent.putExtras(bundle);
                startActivity(intent);
            }
        }
